...
import mindusty.graphics.DrawPseudo3D;

public class TallSeaBushMindusty extends SeaBush {
    ...
    public TallSeaBushMindusty(String name) {
        super(name);
    ...
    public void drawLobes(Tile tile, int level){
        ...
        for(int i = 0; i < lobes; i++){
            ...
            Draw.rect(region,
                    DrawPseudo3D.xHeight(tile.getX(), level),
                    DrawPseudo3D.yHeight(tile.getY(),level),
                    w, h,
                    origin*4f, h/2f,
                    angle
            );
