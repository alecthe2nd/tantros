...
public class BoostOverflowDuct extends OverflowDuct {

    public int max_pressure = 7;

    public BoostOverflowDuct(String name) {
        super(name);
    }
    ...
    public void setBars(){
        super.setBars();
        addBar("pressure", (BoostOverflowDuctBuild entity) -> new Bar(() -> Core.bundle.format("bar.pressure", Mathf.round(Math.max((entity.pressure), 0))), () -> Pal.lightishGray, () -> (float) entity.pressure / max_pressure));
    }

    public class BoostOverflowDuctBuild extends OverflowDuct.OverflowDuctBuild implements BoostPneumatic{
