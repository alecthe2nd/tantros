...
public class SealedPayloadRouter extends PayloadRouter {

    public TextureRegion topsideRegion;
    public TextureRegion sealRegion;

    public SealedPayloadRouter(String name) {
        super(name);
    }
    ...
    public class SealedPayloadRouterBuild extends PayloadRouterBuild{
