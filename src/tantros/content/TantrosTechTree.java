...
public class TantrosTechTree {
    ...
    public static void load(){
        ...
        deepChannels = new Objectives.OnSector(TantrosSectorPresets.deepChannels);
        ...
        Planets.tantros.techTree = TechTree.nodeRoot("tantros", TantrosBlocks.coreShell, true, () -> {
            ...
            TechTree.node(TantrosSource.copperBore, Seq.with(copper, embark), () -> {
                ...
                TechTree.node(TantrosDistribution.copperPipeline, Seq.with(metaglass, deepChannels), () -> {
                    TechTree.node(TantrosDistribution.copperPipelineRouter, Seq.with(metaglass, deepChannels), () -> {
                        TechTree.node(TantrosDistribution.copperLiquidContainer, Seq.with(metaglass, deepChannels), () -> {
                    ...
                    TechTree.node(TantrosDistribution.copperPipelineBridge, Seq.with(metaglass, deepChannels), () -> {
                ...
                TechTree.node(TantrosSource.seawaterIntake, Seq.with(deepChannels), () -> {
                });
            ...
            TechTree.node(TantrosPower.tidalTurbine, Seq.with(shallows), () -> {
                ...
                TechTree.node(TantrosPower.steamEngine, Seq.with(deepChannels), () -> {
                    TechTree.node(TantrosPower.steamDynamo, Seq.with(never), () -> {
            ...
            TechTree.node(TantrosProduction.metaglassAnnealer, Seq.with(shallows), () -> {
                ...
                TechTree.node(TantrosProduction.simpleBoiler, Seq.with(deepChannels),() -> {
                    TechTree.node(TantrosProduction.cystCombustionHeater, Seq.with(deepChannels), () -> {

                        TechTree.node(TantrosProduction.hydrogenCatalysisHeater, Seq.with(never), () -> {
            ...
            TechTree.node(TantrosDefense.copperBulkhead, Seq.with(copper, embark), () -> {
                TechTree.node(TantrosDefense.leadBulkhead, Seq.with(lead, shallows), () -> {
                    TechTree.node(TantrosDefense.metaglassBulkhead, Seq.with(metaglass, deepChannels), () -> {
                        TechTree.node(TantrosDefense.largeMetaglassBulkhead, Seq.with(metaglass, deepChannels), () -> {
                            TechTree.node(TantrosDefense.largeMetaglassBulkheadDoor, Seq.with(never), () -> {
